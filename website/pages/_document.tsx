  ...
  return (
    <Html lang="zh">
      <Head >
        ...
        <meta name="application-name" content="元素周期表PRO - 高颜值化学必备工具" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="default" />
        <meta name="apple-mobile-web-app-title" content="元素周期表PRO - 高颜值化学必备工具" />
        <meta name="mobile-web-app-capable" content="yes" />
        {/* <meta name="msapplication-config" content="/pwa/browserconfig.xml" /> */}
        <meta name="msapplication-TileColor" content="#121314" />
        <meta name="msapplication-tap-highlight" content="no" />
        <meta name="theme-color" content="#FB3BB9" />
        {/* 180x180 */}
        ...
        <link rel="icon" type="image/png" sizes="32x32" href="/pwa/logo_32x32.png" />
        <link rel="icon" type="image/png" sizes="16x16" href="/pwa/logo_16x16.png" />
        <link rel="manifest" href="/manifest.json" />
        <link rel="mask-icon" href="/pwa/logo.svg" color="#121314" />
        <link rel="shortcut icon" href="/favicon.ico" />

        <meta property="og:title" content="元素周期表PRO - 高颜值化学必备工具" />
        <meta property="og:image" content="/og_image.png" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://periodic-table-pro.netlify.app/" />
